...
createDataTable(
  ...
  displayed_columns = c("Vol", "No",
   "Article Title", "Author", "Category", "Year", "Month", "Total Pages", "Unique Identifier", "Notes"),
  ...
  category_columns = c("Vol", "Author", "Category", "Year", "Month",),

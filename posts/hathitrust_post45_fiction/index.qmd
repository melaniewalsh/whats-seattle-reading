...
# data_path = "../../datasets/hathitrust_fiction/hathitrust_post45fiction_metadata.csv"
...
```{ojs}
//|echo: false
import {viewof dataSummaryView, Tabulator, viewof selectedColumns,viewof dataSet, tableContainer, table, viewof twobuttons, viewof selectedPark, viewof park_chart, viewof datasetHeader, tableStyles, createDataTable, mutable dataUrl, fetchData, generateTabulatorTableFromCSV} from "38273b330917a7fe"
```

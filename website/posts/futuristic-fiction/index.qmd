...
Use the search bar to filter records in the table and scatterplot below. Search input can include title, creator (author, director, etc.), year of release or setting (e.g. 2044), and franchise (e.g. Star Trek).

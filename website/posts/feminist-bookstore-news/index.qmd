...
createDataTable(
    data_path = "https://raw.githubusercontent.com/Post45-Data-Collective/data/refs/heads/main/feminist_bookstore_news/feminist_bookstore_news-descriptive.csv",

    # MAKE EDITS HERE: Select the columns that will be displayed in the data table, and the order
    displayed_columns = c(
        "vol", "no", "vol.no", "article_title",
    ...
    # If none, comment out
    column_widths = c(
        "vol" = "50px", "no" = "50px", "author" = "100px", "category" = "120px", "year" = "100px"
        # "prize_name" = "100px"
    ),
...
createDataTable(
    data_path = "https://raw.githubusercontent.com/Post45-Data-Collective/data/refs/heads/main/feminist_bookstore_news/feminist_bookstore_news-issue_list.csv",

    # MAKE EDITS HERE: Select the columns that will be displayed in the data table, and the order
    displayed_columns = c(
        "volume", "number", "year_published", "number_of_pages",
        "format", "notes"
    ),

...
# “Descriptive Database of Articles in *_Feminist Bookstore News_* (1976-2000)”
...
createDataTable(
  data_path = "https://raw.githubusercontent.com/Post45-Data-Collective/website/refs/heads/main/datasets/feminist-bookstore-news/feminist-bookstore-news-descriptive_2024-12-23.csv",

  # MAKE EDITS HERE: Select the columns that will be displayed in the data table, and the order
  displayed_columns = c("vol", "no", "vol.no", "article_title", 
  "author", "category", "year", "month", "notes", "volunteer", "total_pages", "unique_id"),
...
# data <- read.csv("https://raw.githubusercontent.com/Post45-Data-Collective/website/refs/heads/main/datasets/feminist-bookstore-news/feminist-bookstore-news-issue-list_2024-12-23.csv")
# print(names(data))
...
createDataTable(
  data_path = "https://raw.githubusercontent.com/Post45-Data-Collective/website/refs/heads/main/datasets/feminist-bookstore-news/feminist-bookstore-news-issue-list_2024-12-23.csv",

  # MAKE EDITS HERE: Select the columns that will be displayed in the data table, and the order
  displayed_columns = c("volume", "number", "year_published", "number_of_pages", 
  "format", "notes"),

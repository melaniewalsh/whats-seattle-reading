...
::: {.callout-note}
## Originally Published in Responsible Datasets in Context

This essay was originally published as part of the [Responsible Datasets in Context](https://www.responsible-datasets-in-context.com/) project, which curates datasets paired with critical essays for more ethical, humanistic data education. You can view the original version, including programming exercises, [here](https://www.responsible-datasets-in-context.com/posts/spl-500-novels/).
:::
...
```{ojs}
//|echo: false
import {viewof tableTopTitles, plot, headingBlock, viewof selectionInput, viewof tableTopTitlesMode, viewof search} from "f7ac620243f16079"
```

...
title: "Selected British Literary Prizes: 1990 to 2022"
author:
...
categories: [prizes, british, dataset, draft]
...
![Source: [Booker Prize](https://www.thetimes.com/imageserver/image/%2Fmethode%2Ftimes%2Fprod%2Fweb%2Fbin%2F17ab84be-47ff-11ed-bad9-7fa0c293ad00.jpg?crop=1600%2C900%2C0%2C0&format=webp&resize=1500)](https://www.thetimes.com/imageserver/image/%2Fmethode%2Ftimes%2Fprod%2Fweb%2Fbin%2F17ab84be-47ff-11ed-bad9-7fa0c293ad00.jpg?crop=1600%2C900%2C0%2C0&format=webp&resize=1500){fig-align="center" width="50%"}
...
createDataTable(
    data_path = "https://raw.githubusercontent.com/Post45-Data-Collective/data/refs/heads/main/british_literary_prizes/british_literary_prizes-1990-2022.csv",
    # MAKE EDITS HERE: Select the columns that will be displayed in the data table, and the order
    # DISPLAYED COLUMNS
    displayed_columns = c(
        "prize_year", "prize_name", "prize_genre", "prize_institution",
    ...
    column_widths = c(
        "prize_name" = "200px",
        "prize_institution" = "180px",
        "given_name" = "130px",
        "family_name" = "130px",
        "book_title" = "200px",
        "degree_institution" = "160px",
        "ethnicity_macro" = "250px",
        "degree_field_category" = "160px"
    ),

    # CATEGORY COLUMNS
    category_columns = c(
        "prize_genre", "gender", "sexuality", "uk_residence",
...
The prizes in this dataset were included based on their prestige, longevity, and an eye towards generic representation of various kinds of fiction, poetry, drama, and non-fiction. They are the James Tait Black (Fiction and Drama), Costa (Book of the Year, Novel, First Novel, Poetry, Biography, Childrens), Booker, Women’s, Gold Dagger, British Science Fiction Association, T.S. Eliot, Ted Hughes, and Baillie Gifford. This dataset contains primary categories of information on individual authors comprising gender, sexuality, UK residency, ethnicity, geography and details of educational background, including institutions where the authors acquired their degrees and their fields of study. Along with other similar projects, we aim to provide information to assess the cultural, social and political factors determining literary prestige.1 Our aim is to contribute to greater transparency in discussions around diversity and equity in literary prize cultures.
...
1. How many British writers versus writers from ‘elsewhere’ have been shortlisted/awarded these prizes?   
...
**family\_name**: family name of author

**given\_name**: given name of author
...
**uk\_residence**: whether the author holds residence status in the UK
...
# MAKE EDITS HERE: Plug in the raw GitHub URL to the dataset below
createDataTable(
    data_path = "https://raw.githubusercontent.com/Post45-Data-Collective/data/refs/heads/main/british_literary_prizes/british_literary_prizes-ethnicity-1990-2022.csv",
    # MAKE EDITS HERE: Select the columns that will be displayed in the data table, and the order
    # DISPLAYED COLUMNS
    displayed_columns = c(
        "person_id", "ethnicity_parsed"
    ),

    # COLUMN WIDTHS
    column_widths = c(
        "person_id" = "200px",
        "ethnicity_parsed" = "200px"
        # "given_name" = "130px",
        # "family_name" = "130px",
        # "book_title" = "200px",
        # "degree_institution" = "160px",
...
Griffith, Nicola. Literary Prize Data Group. (2015). [nicolagriffith.com/2015/09/08/update-on-literary-prize-data-group/](http://nicolagriffith.com/2015/09/08/update-on-literary-prize-data-group/).  Accessed 6 May 2025\. 
...
Hall, Stuart. (2006). “New Ethnicities.” In *Stuart Hall: Critical Dialogues in Cultural Studies,* David Morley and Kuan-Hsing Chen (eds.). New York: Routledge, 2006, 442--451.
...
Gov.uk. “Writing about Ethnicity.” (2024). [https://www.ethnicity-facts-figures.service.gov.uk/style-guide/writing-about-ethnicity/](https://www.ethnicity-facts-figures.service.gov.uk/style-guide/writing-about-ethnicity/). Accessed 6 May 2025\. 

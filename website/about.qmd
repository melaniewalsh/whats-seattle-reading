...
Lastly, we provide robust documentation for all our datasets by requiring authors to submit ["data essays,"](submissions.qmd) which address the social and historical context of the data, how the data was collected, clean, and categorized, as well as possible ethical concerns or misuses of the data. 

# Support

The Post45 Data Collective has received support from the National Endowment for the Humanities (2024-2026) and Emory’s Program to Enhance Research and Scholarship (PERS) (2023).
...
# Public Writing & Media
 ...
 In October 2022 and November 2023, the Post45 Data Collective partnered with *Public Books* to publish two series of essays, “[Hacking the Culture Industries](https://www.publicbooks.org/tag/hacking-the-culture-industries/),” which both drew on and was inspired by data from the collection. 

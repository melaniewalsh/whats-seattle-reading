...
All datasets are accompanied by a contextual statement or “data essay” that addresses (in **4,000 words or less**) the significance of the data; the social and historical context of the data; how the data was collected, cleaned, and organized; and possible ethical concerns or misuses of the data. 

If you’re interested in submitting a dataset to the Post45 Data Collective, please prepare a data essay with [this template](https://docs.google.com/document/d/1Xm2ikqir-JceGoHwq1dI9qkVcXPTHWTGBAt0R3gN6S8/edit?usp=sharing) and format your data according to the guidelines below. Please submit your essay as a Google Doc or a Word document. We use [Quarto](https://quarto.org/) to create our website, so if you are familiar with Quarto, you can also create your essay with our [.qmd template](https://github.com/Post45-Data-Collective/website/blob/main/data_essay_template.qmd).

When you’re ready, email your dataset and data essay to Melanie Walsh (melwalsh@uw.edu), Alexander Manshel (alexander.manshel@mcgill.ca), and J.D. Porter (porterjd@sas.upenn.edu).

Peer Review & Data Essay Criteria
---------------------------------

Data essays should include the following sections and answer most, if not all, of the following questions. 

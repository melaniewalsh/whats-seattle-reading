...
![Frist, click "Actions" -> "Query data."](images/query.png){width=80% fig-align="left"}

![Then, filter for specific titles or authors. Here the "Creator" field must contain "Stoker" AND "Bram."](images/stoker.png){width=80% fig-align="left"}
...
Finally, we published a mirrored copy of the aggregated monthly checkout data from April 2005-February 2025, which you can download on [Zenodo](https://zenodo.org/records/15792698).

## Canonical American Authors (1945-Present)

[Google Sheet](https://docs.google.com/spreadsheets/d/1a_ifxeHJ_5MlaBo-34sEWwqBMAqhZLLX47xaSDkpzc4/edit?usp=sharing) | [Direct Download](https://seattle-library-checkout-data.s3.us-west-2.amazonaws.com/norton-anthology_spl-checkouts_2005-2025.csv)  

We published a smaller dataset for all works by all authors in Volume E (1945 to the Present) of the most recent 10th edition of the *Norton Anthology of American Literature*.
